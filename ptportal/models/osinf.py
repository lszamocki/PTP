...
class BreachMetrics(abstract_models.TimeStampedModel):
	...
	percentage_emails = models.FloatField(blank=True, validators=[MinValueValidator(0.0), MaxValueValidator(1.0)], verbose_name="Emails Identified in Third-Party Data Breaches (%)")
	...
	def __str__(self):
		return "OSINF Data Breach Metrics"


class BreachedEmail(abstract_models.TimeStampedModel):
    email_address = models.CharField(max_length=500, blank=True, verbose_name="Breached Email Address")
